...
(function(exports) {
  ...
  var SetEventId = (function () {
      function SetEventId(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      SetEventId.create = function (value0) {
          return function (value1) {
              return new SetEventId(value0, value1);
          };
      };
      return SetEventId;
  })();
  ...
  var ui = (function () {
      var render = function (st) {
          return Halogen_HTML_Elements.form_([ Halogen_HTML_Elements.h1_([ Halogen_HTML_Core.text("Lookup event id") ]), Halogen_HTML_Elements.label_([ Halogen_HTML_Elements.div_([ Halogen_HTML_Core.text("Enter eventId:") ]), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.value(st.eventId), Halogen_HTML_Events.onValueInput(Halogen_HTML_Events.input(SetEventId.create)) ]) ]), Halogen_HTML_Elements.button([ Halogen_HTML_Properties.disabled(st.loading), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(MakeRequest.create)) ])([ Halogen_HTML_Core.text("Fetch info") ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text((function () {
              if (st.loading) {
                  return "Working...";
              };
              return "";
              ...
              throw new Error("Failed pattern match at Component line 54, column 11 - line 61, column 16: " + [ st.result.constructor.name ]);
          })()) ]);
      };
      var initialState = {
          loading: false,
      ...
      var $$eval = function (v) {
          ...
          if (v instanceof MakeRequest) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  ...
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                      ...
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Control_Monad_Aff_Class.monadAffAff))(Network_HTTP_Affjax.get(Network_HTTP_Affjax_Response.responsableString)("http://localhost:9090/events/" + v1)))(function (v2) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                              ...
                              $21.loading = false;
                              $21.result = new Data_Maybe.Just(v2.response);
                              return $21;
                          }))(function () {
          ...
          throw new Error("Failed pattern match at Component line 65, column 10 - line 74, column 12: " + [ v.constructor.name ]);
      };
...
(function(exports) {
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Control_Monad_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (v) {
      return Halogen_VDom_Driver.runUI(Component.ui)(Data_Unit.unit)(v);
  }));
  exports["main"] = main;
})(PS["Main"] = PS["Main"] || {});
PS["Main"].main();
